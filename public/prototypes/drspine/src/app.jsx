...
function App() {
  ...
  // Embedded full-bleed in the Spine dashboard's own phone bezel — no device
  // frame or tweaks panel of our own; the dashboard supplies bezel + status bar.
  return (
    <div style={{ position: 'absolute', inset: 0, overflow: 'hidden', borderRadius: 45, background: 'var(--bg)' }}>
